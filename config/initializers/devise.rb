...
Devise.setup do |config|
  ...
  # config.secret_key =
  # 'd3790aafccdd5c9697df5851de2eb90895ac1f57e3ccbcc049b148ca21d63da90e7d395642
  # b0ec1b256e7f2d33fe171c1225f574e3f9607d182e7d41e46f68da'
  ...
  # session.
  # If you need permissions, you should implement that in a before filter.
  ...
  # :subdomain will be used on authentication. The same considerations
  # mentioned for authentication_keys also apply to request_keys.
  # config.request_keys = []
  ...
  # config.pepper =
  # '116e148f74f6d6a04dc81759d3df2f43130b87b31a9c86d5bcb8de2c8dc
  # dd5928da45fb019bd5d1e4433cfa8d9a55c0991c9d9ea28c4f18bb18c4a8ebba713ca'
  ...
  # email db field (see migrations). Until confirmed, new email is stored in
  # unconfirmed_email column, and copied to email column on successful confirm.
  ...
  # :time  = Re-enables login after a certain amount of
  # time (see :unlock_in below)
