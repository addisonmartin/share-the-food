...
ActiveRecord::Schema.define(version: 20_190_427_162_515) do
  ...
  create_table 'active_storage_attachments', force: :cascade do |t|
    ...
    t.index %w[record_type record_id name blob_id], name:
  ...
  create_table 'business_users', force: :cascade do |t|
    ...
    t.index ['reset_password_token'], name:
      'index_business_users_on_reset_password_token', unique: true
  end
  ...
  add_foreign_key 'active_storage_attachments', 'active_storage_blobs', column:
    'blob_id'
end
