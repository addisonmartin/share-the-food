...
RSpec.feature "Infinite scrolling", :type => :feature do
   ...
   scenario "User scrolls down the SLO county page and the donations list will be appended with older donations.", js: true do
   ...
   scenario "User scrolls down the SB county page and the donations list will be appended with older donations.", js: true do
      create_list(:donation, 30, region: create(:region, name: "santa_barbara_county"))
      visit san_luis_obispo_county_donations_path
      #check_donations_count
   end
end
